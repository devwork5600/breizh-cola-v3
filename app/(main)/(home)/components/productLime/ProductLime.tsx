...
export default function ProductLime() {
  return (
    <div className="product-lime relative flex min-h-screen w-full justify-center overflow-hidden px-2 pt-16 lg:px-8 xl:items-center xl:justify-start xl:pt-0">
      ...
      <div className="absolute top-[84vh] left-[35%] sm:top-[57vh] sm:left-[55vw]">
        <MagneticButtons>
          <Link href="/product/lime">
            <button className="text-secondary hover:bg-secondary hover:text-primary bg-primary relative h-22 w-44 rotate-8 cursor-pointer rounded-[50%] border-2 font-bold uppercase sm:h-28 sm:w-56 sm:text-xl md:left-0 md:h-31.25 md:w-62.5 md:text-2xl xl:h-37.5 xl:w-75 xl:text-4xl 2xl:h-45 2xl:w-90 2xl:-rotate-11">
              decouvrez-le
            </button>
          </Link>
        </MagneticButtons>
